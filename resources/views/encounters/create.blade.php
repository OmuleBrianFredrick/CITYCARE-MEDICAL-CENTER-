...
<div style="padding:34px 24px;max-width:900px">
    ...
    <div class="card" style="padding:24px">
        ...
        <form method="POST" action="{{ route('encounters.store') }}" style="display:grid;gap:16px">
            ...
            <label>Initial summary<textarea name="summary" rows="5" style="display:block;width:100%;margin-top:6px;padding:12px;border:1px solid #d9e2ec;border-radius:10px"></textarea></label>
