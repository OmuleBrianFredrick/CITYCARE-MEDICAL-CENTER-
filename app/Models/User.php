...
class User extends Authenticatable
{
    ...
    {
        return $this->hasMany(Charge::class, 'created_by_id');
    }

    public function chargesVoided(): HasMany
    {
        return $this->hasMany(Charge::class, 'voided_by_id');
    }
    ...
    {
        return $this->hasMany(Invoice::class, 'issued_by_id');
    }

    public function invoicesCancelled(): HasMany
    {
        return $this->hasMany(Invoice::class, 'cancelled_by_id');
    }
    ...
    {
        return $this->hasMany(Payment::class, 'voided_by_id');
    }
