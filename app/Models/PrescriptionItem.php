...
class PrescriptionItem extends Model
{
    ...
    {
        return $this->belongsTo(MedicationFormulation::class, 'medication_formulation_id');
    }

    public function dispensingItems()
    {
        return $this->hasMany(MedicationDispensingItem::class);
    }
}
