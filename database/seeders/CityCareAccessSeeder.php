...
class CityCareAccessSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'doctor' => ['name' => 'Doctor / Clinician', 'description' => 'Clinical consultation, assessment, treatment, and referral workflows.', 'permissions' => ['dashboard.view', 'patients.view', 'appointments.manage', 'clinical.encounters.view', 'clinical.encounters.create', 'clinical.encounters.update', 'clinical.vitals.manage', 'clinical.diagnoses.manage', 'clinical.notes.manage', 'clinical.treatment-plans.manage', 'clinical.referrals.manage', 'laboratory.manage', 'pharmacy.manage', 'reports.view']],
            'nurse' => ['name' => 'Nurse / Clinical Support', 'description' => 'Triage, vitals, nursing observations, and assigned clinical support.', 'permissions' => ['dashboard.view', 'patients.view', 'appointments.manage', 'reception.manage', 'clinical.encounters.view', 'clinical.vitals.manage', 'clinical.notes.manage']],
