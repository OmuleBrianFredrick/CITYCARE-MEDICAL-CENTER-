...
class CityCareAccessSeeder extends Seeder
{
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'View prescriptions and medication history', 'slug' => 'pharmacy.view', 'group' => 'pharmacy'],
            ['name' => 'Create prescriptions', 'slug' => 'pharmacy.prescriptions.create', 'group' => 'pharmacy'],
            ['name' => 'Dispense medications', 'slug' => 'pharmacy.dispensing.manage', 'group' => 'pharmacy'],
            ['name' => 'Manage pharmacy work', 'slug' => 'pharmacy.work.manage', 'group' => 'pharmacy'],
            ...
            ['name' => 'View billing and payments', 'slug' => 'billing.view', 'group' => 'billing'],
            ['name' => 'Manage billing charges', 'slug' => 'billing.charges.manage', 'group' => 'billing'],
            ['name' => 'Manage invoices', 'slug' => 'billing.invoices.manage', 'group' => 'billing'],
            ['name' => 'Record billing payments', 'slug' => 'billing.payments.record', 'group' => 'billing'],
            ['name' => 'Manage billing work', 'slug' => 'billing.work.manage', 'group' => 'billing'],
        ...
        $roles = [
            ...
            'administrator' => ['name' => 'Administrator', 'description' => 'Operational management across the medical center.', 'permissions' => ['dashboard.view', 'organization.view', 'organization.manage', 'patients.view', 'patients.create', 'patients.update', 'appointments.manage', 'reception.manage', 'clinical.encounters.view', 'laboratory.view', 'laboratory.orders.create', 'laboratory.work.manage', 'laboratory.manage', 'pharmacy.view', 'pharmacy.prescriptions.create', 'pharmacy.dispensing.manage', 'pharmacy.work.manage', 'pharmacy.manage', 'inventory.view', 'inventory.manage', 'billing.view', 'billing.charges.manage', 'billing.invoices.manage', 'billing.payments.record', 'billing.work.manage', 'billing.manage', 'reports.view', 'staff.manage', 'audit.view']],
            'receptionist' => ['name' => 'Receptionist', 'description' => 'Front-desk patient registration, scheduling, check-in, and queue operations.', 'permissions' => ['dashboard.view', 'patients.view', 'patients.create', 'patients.update', 'appointments.manage', 'reception.manage', 'billing.view']],
            'doctor' => ['name' => 'Doctor / Clinician', 'description' => 'Clinical consultation, assessment, treatment, and referral workflows.', 'permissions' => ['dashboard.view', 'patients.view', 'appointments.manage', 'clinical.encounters.view', 'clinical.encounters.create', 'clinical.encounters.update', 'clinical.vitals.manage', 'clinical.diagnoses.manage', 'clinical.notes.manage', 'clinical.treatment-plans.manage', 'clinical.referrals.manage', 'laboratory.view', 'laboratory.orders.create', 'pharmacy.view', 'pharmacy.prescriptions.create', 'pharmacy.manage', 'billing.view', 'reports.view']],
            'nurse' => ['name' => 'Nurse / Clinical Support', 'description' => 'Triage, vitals, nursing observations, and assigned clinical support.', 'permissions' => ['dashboard.view', 'patients.view', 'appointments.manage', 'reception.manage', 'clinical.encounters.view', 'clinical.vitals.manage', 'clinical.notes.manage', 'laboratory.view', 'pharmacy.view']],
            ...
            'pharmacy' => ['name' => 'Pharmacy Staff', 'description' => 'Prescription processing, dispensing, and pharmacy stock operations.', 'permissions' => ['dashboard.view', 'patients.view', 'pharmacy.view', 'pharmacy.dispensing.manage', 'pharmacy.work.manage', 'pharmacy.manage', 'inventory.view', 'reports.view']],
            'cashier' => ['name' => 'Cashier / Finance', 'description' => 'Billing, payment, receipt, balance, and authorized financial operations.', 'permissions' => ['dashboard.view', 'patients.view', 'billing.view', 'billing.charges.manage', 'billing.invoices.manage', 'billing.payments.record', 'billing.work.manage', 'billing.manage', 'reports.view']],
