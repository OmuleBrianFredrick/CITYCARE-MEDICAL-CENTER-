...
class CityCareAccessSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $roles = [
            ...
            'doctor' => ['name' => 'Doctor / Clinician', 'description' => 'Clinical consultation, assessment, treatment, and referral workflows.', 'permissions' => ['dashboard.view', 'patients.view', 'appointments.manage', 'clinical.encounters.view', 'clinical.encounters.create', 'clinical.encounters.update', 'clinical.vitals.manage', 'clinical.diagnoses.manage', 'clinical.treatment-plans.manage', 'laboratory.manage', 'pharmacy.manage', 'reports.view']],
